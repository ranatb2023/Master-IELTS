...
{
    /**
     * Get all notifications for tutor with filters
     */
    public function index(Request $request)
    {
        ...
        if ($request->has('category') && $request->category !== 'all') {
            $categoryMap = [
                'students' => ['NewStudentEnrolledNotification'],
                'assignments' => ['AssignmentSubmittedNotification'],
                'courses' => ['CoursePublishedNotification'],
                'reviews' => ['NewReviewReceivedNotification'],
            ];
