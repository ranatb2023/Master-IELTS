    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" x-data="{
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900">Create New Note</h2>
                    <p class="mt-1 text-sm text-gray-600">Capture your learning insights and ideas</p>
                </div>
            ...
            <form action="{{ route('student.notes.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <!-- Body Card -->
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            <x-quill-editor name="body" label="Note Content" :value="old('body', '')" :required="true"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="space-y-4">
                                    ...
                                    <select name="course_id" id="course_id"
                                        ...
                                        @foreach ($userCourses as $course)
                                            <option value="{{ $course->id }}"
                                                {{ old('course_id', $course?->id ?? '') == $course->id ? 'selected' : '' }}>
                                                {{ $course->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    @if ($lesson)
                                        <p class="mt-1 text-xs text-gray-500">📌 {{ $lesson->title }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="color" id="color"
                                        ...
                                        <option value="yellow" {{ old('color') == 'yellow' ? 'selected' : '' }}>🟡 Yellow
                                        </option>
                                        ...
                                        <option value="pink" {{ old('color') == 'pink' ? 'selected' : '' }}>🩷 Pink
                                        </option>
                                        <option value="orange" {{ old('color') == 'orange' ? 'selected' : '' }}>🟠 Orange
                                        </option>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                            ...
                            <input id="files" type="file" name="attachments[]" multiple class="hidden"
                                @change="handleFileSelect($event)" accept="*/*">
