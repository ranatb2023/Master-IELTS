...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.permissions.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-md">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        ...
                        <div class="text-sm text-gray-500">{{ str_replace('.', ' › ', $permission->name) }}</div>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-right text-sm font-medium">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('admin.permissions.show', $permission) }}" class="text-blue-600 hover:text-blue-900">
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-6 py-12 text-center text-gray-500">No permissions found</td>
                </tr>
                @endforelse
            </tbody>
        </table>
