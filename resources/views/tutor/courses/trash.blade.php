...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Restore or permanently delete your courses</p>
        </div>
        <a href="{{ route('tutor.courses.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
    ...
    <div class="bg-white p-4 rounded-lg shadow">
        <form method="GET" action="{{ route('tutor.courses.trash') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('tutor.courses.trash') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Reset</a>
            </div>
        </form>
    </div>
                ...
                @forelse($courses ?? [] as $course)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium space-x-2">
                            <!-- Restore Button -->
                            <form method="POST" action="{{ route('tutor.courses.restore', $course->id) }}" class="inline-block">
                                @csrf
                            ...
                            <form method="POST" action="{{ route('tutor.courses.force-delete', $course->id) }}" class="inline-block">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <a href="{{ route('tutor.courses.index') }}" class="mt-2 inline-block text-indigo-600 hover:text-indigo-500">
                                View all courses
                            </a>
                        </td>
                    </tr>
