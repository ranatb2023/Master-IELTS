...
<div class="container-fluid px-4 py-6">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Manage and respond to student comments on your course lessons.</p>
        </div>
    </div>

    <!-- Filters Card -->
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form method="GET" action="{{ route('tutor.lesson-comments.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
            ...
            <div class="md:col-span-2 lg:col-span-4 flex items-end space-x-2">
                ...
                <a href="{{ route('tutor.lesson-comments.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300">
                    Clear
                </a>
            </div>
        </form>
                        ...
                        @foreach($comments as $comment)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('tutor.courses.topics.lessons.show', [$comment->lesson->topic->course, $comment->lesson->topic, $comment->lesson]) }}#comment-{{ $comment->id }}" 
                                        class="text-indigo-600 hover:text-indigo-900">View & Reply</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    ...
                    @else
                        Students haven't posted any comments on your courses yet.
                    @endif
                </p>
            </div>
        @endif
