...
<head>
    ...
    <title>{{ config('app.name', 'Master IELTS') }} - Login</title>
    ...
    <style>
        ...
        /* Login Page Styles from mainstyle.css */
        .login-bg-gradient {
            ...
            <div class="flex w-full max-w-7xl h-full gap-8 lg:gap-[48px]">
                    ...
                    <div class="relative z-10 flex flex-col justify-between h-full px-6 py-12">
                        ...
                        <div class="max-w-xl">
                            <p
                                ...
                                and task
                                achievement. Our Writing Course trains you to plan effectively, express your thoughts
                                clearly, and
                ...
                <div class="flex-1 relative flex flex-col justify-center text-white">
                    ...
                    <div class="relative z-10 flex flex-col w-full">
                        ...
                        <p class="text-white/80 text-[16px] md:text-[18px] mb-8">Please fill the form to login.</p>
                        ...
                        <form class="flex flex-col gap-5" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="flex flex-col gap-2">
                                <label for="email" class="text-white text-[16px] font-medium">Email Address*</label>
                                <div class="relative">
                            ...
                            <div class="flex items-center justify-between mt-1">
                                <label for="remember_me" class="flex items-center gap-2 cursor-pointer group">
                                    <input id="remember_me" type="checkbox" name="remember"
                                        class="w-4 h-4 rounded border-gray-400 bg-transparent text-white focus:ring-offset-0 focus:ring-transparent checked:bg-white checked:border-white transition-all appearance-none border relative checked:before:content-['✓'] checked:before:absolute checked:before:text-Dark-Blue checked:before:text-[10px] checked:before:font-bold checked:before:top-1/2 checked:before:left-1/2 checked:before:-translate-x-1/2 checked:before:-translate-y-1/2">
                                    <span class="text-[14px] text-white/90 group-hover:text-white transition">Keep me
                                        signed in</span>
                                </label>
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}"
                                        class="text-[14px] font-medium text-white hover:text-white/80 underline decoration-1 underline-offset-4 transition">
                                        Forgot password?
                                    </a>
                                @endif
                            </div>
                        ...
                        <div class=" text-white/80 text-[16px]">
                            ...
                            <a href="{{ route('register') }}"
                                class="text-white font-bold hover:underline underline-offset-4 decoration-white ml-1">Register
                                Now</a>
                        </div>
                    </div>
                </div>
